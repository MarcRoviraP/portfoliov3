                ...
                <div className="absolute top-4 right-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {proyecto.technologies.map((tech, i) => (
                      <span 
                        key={i} 
                        className="px-2 py-1 bg-gray-800/80 border border-gray-700 text-cyan-400 text-[10px] uppercase tracking-wider font-bold rounded-md backdrop-blur-sm transition-colors duration-300 group-hover:border-cyan-500/50 group-hover:bg-cyan-500/10"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex gap-4">
                    ...
                    {/* Botón de Web (si existe) */}
                    {(proyecto as any).url_web && (
                      <a
